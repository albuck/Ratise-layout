...
+ Klaviatūrose gali nebūti ne tik Ratisės ```-``` mygtuko (apačioje kairėje), bet ir Ratisės ```+``` mygtuko (dešinėje viršuje) — šie mygtukai _ISO/IEC 9995_ standarte nėra privalomi.
