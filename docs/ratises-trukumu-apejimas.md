...
4. __Mygtukas ```W``` nėra labai patogioje vietoje.__ Todėl yra teikiama papildoma Ratisės išdėstymo atmaina ISO klaviatūroms (kurios yra su papildomu mygtuku) su sukeistais 'W' ir brūkšnelio ženklais vietomis: [Ratisė W](images/lt-ratise-w.svg).
