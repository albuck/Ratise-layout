...
+ [Keyboard Layout Analyzer: Jonas Biliūnas „Brisiaus galas“](http://patorjk.com/keyboard-layout-analyzer/#/load/2JffnkBG)

   1. __Ratise (ISO) — 69.24__
   2. LEKP (ISO) — 60.05
   3. LT Standard 2000 (ISO) — 49.10
   4. QWERTY Baltic+ (ISO) — 46.89
...
+ [Keyboard Layout Analyzer: Vikipedijos straipsnis „Fizika“](http://patorjk.com/keyboard-layout-analyzer/#/load/FqCxtsPD) (pataisyti ilgieji brūkšniai)

   1. __Ratise (ISO) — 67.06__
   2. LEKP (ISO) — 60.25
   3. QWERTY Baltic+ (ISO) — 45.20
   4. LT Standard 2000 (ISO) — 45.17
...
+ [Keyboard Layout Analyzer: Vikipedijos straipsnis „Lietuva“](http://patorjk.com/keyboard-layout-analyzer/#/load/7GnPCKgL) (pataisyti ilgieji brūkšniai)

   1. __Ratise (ISO) — 61.15__
   2. LEKP (ISO) — 53.83
   3. LT Standard 2000 (ISO) — 41.49
   4. QWERTY Baltic+ (ISO) — 40.88
...
+ [Keyboard Layout Analyzer: “Scientific Papers”](http://patorjk.com/keyboard-layout-analyzer/#/load/wlG7LJrQ)

   1. __Ratise (ISO) — 58.91__
   2. LEKP (ISO) — 58.41
   3. QWERTY Baltic+ (ISO) — 43.25
   4. LT Standard 2000 (ISO) — 38.98

  __Pastaba:__ kai kuriuose papildomai bandytuose angliškuose tekstuose _LEKP_ pasirodo kiek geriau nei _Ratisė_.
