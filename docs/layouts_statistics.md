...
+ __Posible Lithuanian keyboard layouts (written in italics) .__ Known English layouts with additional Lithuanian characters are added at the third level or, in the case of Colemak LT Numeric, at the top instead of the numbers, with some additional tweaks. Lolemak LT is a Colemak LT with several conversions (R, S, A letters swapped). “Arietis” is a layout obtained by trying to adapt Ratisė to the English language (Lithuanian letters in the third-fourth level). Ratisė Standard is a variant of the Ratisė layout with numbers at the top and non-Lithuanian letters in the third level. The Albuck LT and Buckal LT layouts are an attempt to apply the Ratisė development experience to English language and programming (layouts have Lithuanian characters at the third level), also with some more traditional approach.
