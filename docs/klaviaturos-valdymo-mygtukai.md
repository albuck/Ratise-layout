...
+ Tarp kairiųjų ```Ctrl``` ir ```OS``` mygtukų kai kuriose klaviatūrose įsiterpia ```Fn``` mygtukas: su juo kartu spaudžiant kitą kokį klaviatūros mygtuką keičiamas pastarojo veikmuo (funkcija).
