...
__Pastabos:__ 
+ Lyginant su [įprastomis kompiuterio klaviatūromis](https://upload.wikimedia.org/wikipedia/commons/a/a2/LenovoKeyboard.jpg){:target="_blank"} [Apple klaviatūroje](https://upload.wikimedia.org/wikipedia/commons/e/ea/Apple_iMac_Keyboard_A1243.png){:target="_blank"} mygtukai <kbd>⌥ Option (⎇ Alt)</kbd> ir <kbd>⌘ Command (⊞ Win)</kbd> savo padėtimi yra sukeisti vietomis pačioje klaviatūroje.
