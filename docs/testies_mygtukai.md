...
+ Linux aplinkoje ‘Tab’ trečiajame lygyje veikia kaip sudurtinio įvedimo mygtukas (angliškai vadinamas ‘Multi key’ ar ‘Compose key’). Apie sudurtinį įvedimą (angliškai): https://help.ubuntu.com/community/ComposeKey
