...
+ Linux aplinkoje ‘Tab’ trečiajame lygyje veikia kaip _sudurtinio įvedimo mygtukas_ (angliškai vadinamas ‘Multi key’ ar ‘Compose key’), pavyzdžiui, paspaudus šį mygtuką o paskui ‘d’ ir po to ‘i’ gaunamas ‘⌀’ (skersmens ženklelis). Plačiau apie sudurtinį įvedimą (angliškai): https://help.ubuntu.com/community/ComposeKey
