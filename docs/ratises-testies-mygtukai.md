...
+ _Linux/Unix_ vartotojams norintiems naudotis papildomais Ratisės tęstinių mygtukų ženklais būtina išdėstymo įdiegimo aplanke _XKB_ esančią bylą _XCompose_ patalpinti į namų aplanką ir pervardinti ją į _.XCompose_ (pridėti tašką pradžioje). Toliau reikia perkrauti sistemą ar pakartotinai atsijungti-prisijungti prie savosios paskyros. 
