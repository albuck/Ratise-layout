...
• _Pastabėlė_. Sprendžiant iš rodmenų: programuotojams tikrai derėtų pagalvoti apie tikrai ergonomiškos ir programuojamos klaviatūros įsigijimą ar pasigaminimą [žiūrėkite nuorodas pirmojo puslapio apačioje](../README.md). Taip pat apie ‘Alt’ ir ‘Shift’ mygtukų sukeitimą vietomis ar ‘Shift‘ (ar/ir ‘Enter’, ‘Tab’) priskyrimą pajėgesniam pirštui (didžiajam). 
