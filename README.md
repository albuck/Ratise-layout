...
+ Kairės ir dešinės rankos pirštų pagrindinės padėtys atitinkamai yra: <kbd>u</kbd><kbd>e</kbd><kbd>i</kbd><kbd>**a**</kbd> <kbd>**r**</kbd><kbd>t</kbd><kbd>s</kbd><kbd>p</kbd> (čia paryškintos tenkančios rankų smiliams raidės).
