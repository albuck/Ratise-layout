...
Tai reiškia, kad renkant tekstą Ratisės išdėstymu jums prireiks žymiai mažiau pastangų nei kitais lietuviškais išdėstymais:

- [Lietuviškų klaviatūros išdėtymų palyginamoji patikra](https://albuck.github.io/lithuanian-keyboard-layouts/images/test-klanext-lt-txt.png), paveikslėlis paimtas iš [Keyboard Layout Analyzer : KLAnext v0.06](https://klanext.keyboard-design.com/#/about) puslapio.
